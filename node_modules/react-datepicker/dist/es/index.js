...
import k from "date-fns/getWeek";
...
function Ce(e, t, r, n) {
  ...
  return Array.isArray(t)
    ? (t.forEach(function (t) {
        ...
        n && (p = _e(r) && e === o(r, t, { awareOfUnicodeTokens: !0 })),
          _e(r) && p && (a = r);
      }),
      a)
    : ((a = J(e, t, new Date(), { locale: s })),
      n
        ? (p = _e(a) && e === o(a, t, { awareOfUnicodeTokens: !0 }))
        : _e(a) ||
          ((t = t
            .match(ge)
            .map(function (e) {
...
function Qe(e, t) {
  return Se(E(be(), e), "LLLL", t);
}
function Ve(e, t) {
  return Se(E(be(), e), "LLL", t);
}
function qe(e, t) {
  return Se(N(be(), e), "QQQ", t);
}
function Ue(e) {
...
function Xe(e) {
  var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
    ...
    n = t.maxDate,
    o = new Date(e, 0, 1);
  return et(o, { minDate: r, maxDate: n }) || !1;
}
function Ze(e, t, r, n) {
  var o = C(e),
    a = b(e),
...
var ft = Z(
    (function (r) {
      ...
      function o(t) {
        var r;
        ae(this, o),
          ie(fe((r = n.call(this, t))), "renderOptions", function () {
            var t = r.props.year,
  ...
  yt = (function (t) {
    ...
    function n() {
      ...
      for (var o = arguments.length, a = new Array(o), s = 0; s < o; s++)
        a[s] = arguments[s];
      return (
        ie(fe((t = r.call.apply(r, [this].concat(a)))), "state", {
          dropdownVisible: !1,
        }),
    ...
    (function (r) {
      ...
      function o(t) {
        ...
        return (
          ...
          (r.state = { monthYearsList: wt(r.props.minDate, r.props.maxDate) }),
          r
        );
      }
      return (
  ...
  gt = (function (t) {
    ...
    function n() {
      ...
      return (
        ...
        ie(fe(t), "renderSelectOptions", function () {
          for (
            var r = xe(t.props.minDate), n = xe(t.props.maxDate), o = [];
            !U(r, n);
            ...
            o.push(
              e.createElement(
                "option",
                { key: a, value: a },
                Se(r, t.props.dateFormat, t.props.locale)
              )
            ),
              (r = c(r, 1));
          }
  ...
  bt = (function (r) {
    ...
    function o() {
      ...
      for (var a = arguments.length, s = new Array(a), p = 0; p < a; p++)
        s[p] = arguments[p];
      return (
        ie(fe((r = n.call.apply(n, [this].concat(s)))), "dayEl", e.createRef()),
        ie(fe(r), "handleClick", function (e) {
        ...
        ie(fe(r), "getClassNames", function (e) {
          ...
          return t(
            ...
            n,
            "react-datepicker__day--" + Ee(r.props.day),
            {
        ...
        ie(fe(r), "getTabIndex", function (e, t) {
          ...
          return r.isKeyboardSelected() || (r.isSameDay(n) && Fe(o, n))
            ? 0
            : -1;
        }),
    ...
    function o() {
      ...
      return (
        ...
        ie(fe(r), "renderWeeks", function () {
          for (
            var t = [],
              ...
              o = Oe(xe(r.props.day), r.props.locale),
              a = 0,
              s = !1;
            t.push(
              e.createElement(_t, {
        ...
        ie(fe(r), "onMonthClick", function (e, t) {
          r.handleDayClick(xe(E(r.props.day, t)), e);
        }),
        ...
        ie(fe(r), "onQuarterClick", function (e, t) {
          r.handleDayClick(Ye(N(r.props.day, t)), e);
        }),
  ...
  Mt = (function (t) {
    ...
    function n() {
      ...
      for (var o = arguments.length, s = new Array(o), p = 0; p < o; p++)
        s[p] = arguments[p];
      return (
        ie(fe((t = r.call.apply(r, [this].concat(s)))), "state", {
          height: null,
        }),
        ie(fe(t), "handleClick", function (e) {
          ((t.props.minTime || t.props.maxTime) && nt(e, t.props)) ||
        ...
        ie(fe(t), "renderTimes", function () {
          for (
            var r = [],
              ...
              c = t.props.selected || t.props.openToDate || be(),
              l = v(c),
              d = y(c),
              u = P(M(s, d), l),
              h = 0;
...
var Pt = (function (r) {
    ...
    function o(e) {
      ...
      return (
        ae(this, o),
        ie(fe((r = n.call(this, e))), "handleYearClick", function (e, t) {
        ...
        ie(fe(r), "isKeyboardSelected", function (e) {
          var t = Te(O(r.props.date, e));
          return (
            !r.props.disabledKeyboardNavigation &&
            !r.props.inline &&
            !Fe(t, Te(r.props.selected)) &&
            Fe(t, Te(r.props.preSelection))
          );
        }),
        ie(fe(r), "onYearClick", function (e, t) {
          var n = r.props.date;
          r.handleYearClick(Te(O(n, t)), e);
        }),
        ie(fe(r), "getYearClassNames", function (e) {
          ...
          return t("react-datepicker__year-text", {
            ...
            "react-datepicker__year-text--today": e === C(be()),
          });
        }),
        r
      );
  ...
  Et = (function (t) {
    ...
    function n(t) {
      ...
      return (
        ae(this, n),
        ie(fe((o = r.call(this, t))), "onTimeChange", function (e) {
          o.setState({ time: e });
          var t = new Date();
...
var Ot = [
  ...
  xt = (function (r) {
    ...
    function o(r) {
      ...
      return (
        ae(this, o),
        ie(fe((a = n.call(this, r))), "handleClickOutside", function (e) {
          ...
          if (a.props.todayButton && !a.props.showTimeSelectOnly)
            return e.createElement(
              "div",
              {
                ...
                onClick: function (e) {
                  return a.props.onSelect(R(be()), e);
                },
              },
              a.props.todayButton
            );
        ...
        ie(fe(a), "renderInputTimeSection", function () {
          var t = new Date(a.props.selected),
            r =
              _e(t) && Boolean(a.props.selected)
                ? "".concat(ut(t.getHours()), ":").concat(ut(t.getMinutes()))
                : "";
  ...
  Yt = (function (t) {
    ...
    function n(t) {
      ...
      return (
        ae(this, n),
        ie(fe((o = r.call(this, t))), "getTabChildren", function () {
        ...
        [
          {
            ...
            value: function () {
              ...
              this.props.popperContainer &&
                ...
                m && !s && (r = e.createElement(It, { portalId: m }, r));
...
var Ft = (function (n) {
    ...
    function a(n) {
      ...
      return (
        ae(this, a),
        ie(fe((s = o.call(this, n))), "getPreSelection", function () {
        ...
        ie(fe(s), "handleChange", function () {
          ...
          if (
            ...
            s.setState({ inputValue: n.target.value, lastPreSelectChange: At });
            var o = Ce(
              n.target.value,
              s.props.dateFormat,
              s.props.locale,
        ...
        ie(fe(s), "setSelected", function (e, t, r, n) {
          ...
          if (null === o || !Ue(o, s.props)) {
            var a = s.props,
              ...
              c = a.startDate,
              l = a.endDate;
            if (!Ae(s.props.selected, o) || s.props.allowSameDay || i)
              if (
                (null !== o &&
                  (!s.props.selected ||
                    (r &&
        ...
        ie(fe(s), "setPreSelection", function (e) {
          ...
          e &&
            (t && r
              ? (n = We(e, s.props.minDate, s.props.maxDate))
              : t
        ...
        ie(fe(s), "onInputKeyDown", function (e) {
          ...
          if (s.state.open || s.props.inline || s.props.preventOpenOnFocus) {
            if (s.state.open) {
              ...
              "Enter" === t
                ? (e.preventDefault(),
                  s.inputOk() && s.state.lastPreSelectChange === Wt
                    ? (s.handleSelect(n, e),
        ...
        ie(fe(s), "onDayKeyDown", function (e) {
          ...
          if ("Enter" === t)
            ...
            e.preventDefault(),
              s.setState({ lastPreSelectChange: Wt }),
        ...
        ie(fe(s), "renderDateInput", function () {
            ...
            d =
              "string" == typeof s.props.value
                ...
                : ((n = s.props.selected),
                  ...
                  (a = o.dateFormat),
                  (p = o.locale),
                  (n && Se(n, Array.isArray(a) ? a[0] : a, p)) || "");
          return e.cloneElement(
            ...
            ie(r, "value", d),
            ie(r, "onBlur", s.handleBlur),
            ie(r, "onChange", s.handleChange),
            ie(r, "onClick", s.onInputClick),
            ie(r, "onFocus", s.handleFocus),
            ie(r, "onKeyDown", s.onInputKeyDown),
            ie(r, "id", s.props.id),
            ie(r, "name", s.props.name),
            ie(r, "autoFocus", s.props.autoFocus),
            ie(r, "placeholder", s.props.placeholderText),
            ie(r, "disabled", s.props.disabled),
            ie(r, "autoComplete", s.props.autoComplete),
            ie(r, "className", t(c.props.className, i)),
            ie(r, "title", s.props.title),
            ie(r, "readOnly", s.props.readOnly),
            ie(r, "required", s.props.required),
            ie(r, "tabIndex", s.props.tabIndex),
            ie(r, "aria-labelledby", s.props.ariaLabelledBy),
            r)
          );
        }),
...
export default Ft;
export {
  Nt as CalendarContainer,
  je as getDefaultLocale,
  Be as registerLocale,
  Ke as setDefaultLocale,
};
